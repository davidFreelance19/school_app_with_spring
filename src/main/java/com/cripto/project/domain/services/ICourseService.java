...
public interface ICourseService extends ICrudService<CourseDtoResponse, CourseDtoRequest>{
    ...
    public Map<String, List<CourseDtoResponse>> getCoursesToTeacher(String username);
